---
title: "andrej-karpathy-skills/README.zh.md at main"
source: "https://github.com/forrestchang/andrej-karpathy-skills/blob/main/README.zh.md"
author:
published:
created: 2026-04-29
description: "A single CLAUDE.md file to improve Claude Code behavior, derived from Andrej Karpathy's observations on LLM coding pitfalls. - andrej-karpathy-skills/README.zh.md at main · forrestchang/andrej-karpathy-skills"
tags:
  - "clippings"
---

## 1 受 Karpathy 启发的 Claude Code 指南
...
[English](https://github.com/forrestchang/andrej-karpathy-skills/blob/main/README.md) | 简体中文
...
本仓库包含一个已提交的 Cursor 项目规则 ([`.cursor/rules/karpathy-guidelines.mdc`](https://github.com/forrestchang/andrej-karpathy-skills/blob/main/.cursor/rules/karpathy-guidelines.mdc))，因此在 Cursor 中打开项目时同样适用这些指南。详情请参见 **[CURSOR.md](https://github.com/forrestchang/andrej-karpathy-skills/blob/main/CURSOR.md)** ，包括如何在其他项目中使用该规则，以及它与 Claude Code 的关系。
